...
<body>
    ...
    <div class="container">
      ...
      <div class="menu">
        <ul class="menu-items hidden">
          ...
          <li><a href="#propiedades">Propriétés</a></li>
  ...
  <div class="language-selector">
    <div class="selected-language">
      ...
      <a href="../EN/Milenio21.php"><img src="../iconos/estados-unidos.png" alt="French Flag" /></a>
  ...
  <div class="video-background">
    ...
    <div class="search-container">
      ...
      <select id="status" onchange="redirectToLink()">
        ...
        <option value="Departamento">Appartement</option>
        <option value="Casa">Maison</option>
        <option value="Condominio">Condo</option>
        <option value="Estudio">Studio</option>
        <option value="Penthouse">Penthouse</option>
        <option value="Terreno">Aterrier</option>
        <option value="Edificio">Bâtiments</option>
      </select>
      <select id="bedrooms" onchange="redirectToLink()">
        <option value="" disabled selected hidden>N. Chambres</option>
      ...
      <select id="bathrooms" onchange="redirectToLink()">
        <option value="" disabled selected hidden>N. Bains</option>
        <option value="1">1 - 2</option>
        <option value="2">2 - 3</option>
        <option value="3">3 - 4</option>
        <option value="4">4 - 5</option>
  ...
  <h1 class="tituloPropiedades">Propriétés</h1>
  ...
  <?php
    ...
    while ($fila = mysqli_fetch_assoc($resultado)) {
      ...
      $nombreFrances = $traduccionesNombre["fr"];
      
      $descripcionFrances = $traduccionesDescripcion["fr"];
      ?>
      ...
      <div class="property propertys">
        ...
        <a href="propiedades/propiedad/<?php echo $fila['id']; ?>.php">
          ...
          <div class="property-details">
            <h3>
              <?php echo $nombreFrances; ?>
            </h3>
            <p>
              <?php
              $descripcion = $descripcionFrances;
              $max_length = 95;
            ...
            <div class="property-info">
              <p><img src="../iconos/dormitorio.png" alt="" />
                <?php echo $fila['num_habitaciones']; ?> Chambres
              </p>
              <p><img src="../iconos/inodoro.png" alt="" />
                <?php echo $fila['num_banos']; ?> Bains
              </p>
              <p>
              ...
              <p>statut : vente</p>
              <p>
                <img src="../iconos/signo-de-dolar.png" alt="" /> Prix: $
  ...
  <div class="MexicoLindo">
    <h1 class="Conoce">Mexique</h1>
    <h1 class="Mexico">Mignon</h1>
  </div>
  <section class="properties">
    ...
    <div class="property property7">
      ...
      <div class="property-details">
        <h3 style="color: green;">Mexique Mignon</h3>
      </div>
    </div>
  </section>
  <a name="contacto"></a>
  ...
  <footer>
    <div class="footer-content">
      <div class="contacto">
        ...
        <p>
          <i class="fas fa-map-marker-alt"></i> Cancun Quintana Roo Mexique 77536
        </p>
      </div>
    </div>
    <div class="copyrigth">
