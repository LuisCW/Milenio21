...
while ($fila = mysqli_fetch_assoc($resultado)) {
    ...
    $ruta_archivo = $_SERVER['DOCUMENT_ROOT'] . '/viviendas/FR/propiedades/propiedad/' . $nombre_archivo;
    ...
    //Volver al dashboard
    echo '<script>
                window.location = "crear_publicacion_ch.php";
            </script>';
}       
?>
