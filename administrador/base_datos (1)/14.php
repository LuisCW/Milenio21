<!DOCTYPE html>
    ...
    <body>
        ...
        $servername = "jbh.e42.myftpupload.com";
        $username = "Iht92=jT@Tbury";
        $password = "J0cUbEuCjzOwUR";
        $dbname = "viviendas";
    
        $conn = mysqli_connect($servername, $username, $password, $dbname);
    
        // Verificar si la conexión se realizó correctamente ssh Iht92=jT@Tbury@jbh.e42.myftpupload.com
        if (!$conn) {
